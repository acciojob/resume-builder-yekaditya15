      ...
      <form autoComplete="off" noValidate>
        <Card>
          ...
          <div className={classes.footer}>
           <Button id='delete' disabled={ props.projectFormData.Count<2} className={classes.deleteButton} onClick={Deleteducation} variant="outlined" color="primary" >
            Delete
          </Button>
          <Button id='add_project' className={classes.addButton} onClick={AddEducation} variant="contained" color="primary">
            ADD Project
          </Button>
          </div>
        </Card>
